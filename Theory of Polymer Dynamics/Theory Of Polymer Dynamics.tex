...
\end{cases}
\end{equation*}
note that $\frac{N-(N-1)^2}{N(1-N)}-1 = \frac{2N-1}{N(1-N)} $. So, we write 
\begin{equation*}
C^{-1}_\Delta(s,t) = 
\begin{cases}
\alpha    & s=t\\
...
\end{equation*}
Note that when $\alpha=1$ the system becomes decoupled. This happens at the limit $N\rightarrow \infty$

\subsection{The distribution of bond vectors in equilibrium}\label{subsection_distributionOfBondAtEquilibrium}
