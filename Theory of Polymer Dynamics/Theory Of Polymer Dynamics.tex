...
In our case $c_0=\sigma^2_\Delta=1+k(N)$, and  $c_{N-1}=...=c_1=k(N)$, therefore 
\begin{eqnarray*}
\lambda_j & = & \sigma^2_\Delta + k(n)\sum_{n=1}^{N-1}\omega_j^n
            =  1+k(N)\left( 1+\sum_{n=1}^{N-1}\exp(\frac{2\pi nij}{N}\right)\\ 
          & = & 1+k(N)\sum_{n=0}^{N-1}\exp(\frac{2\pi nij}{N})\\ 
          & = & 1+k(N)\left( \frac{1-\exp(2\pi i j)}{1-\exp(2\pi i j/N)}  \right)\\          
\end{eqnarray*}
